...
from .views import UserListCreateAPIView, UserDetailAPIView, CurrentUserView, LoginView, RegisterView, MedicineCreateAPIView, MedicineUpdateAPIView, MedicineDeleteAPIView, MedicineSearchAPIView, MedicineListAPIView, MedicineDetailAPIView, ScheduleListCreateAPIView, ScheduleDetailAPIView, PatientAppointmentListCreateAPIView, PatientAppointmentDetailAPIView
